...
t_component_rocket::t_component_rocket(const t_rocket_id_entity id, const t_spaceship_id_entity aim_id, const t_2d_position& position)
    : _id { id }
    , _aim_id { aim_id }
    , _position { position }
{
...
t_2d_position& t_component_rocket::position() { return _position; }

t_2d_position t_component_rocket::get_position() const { return _position; }
