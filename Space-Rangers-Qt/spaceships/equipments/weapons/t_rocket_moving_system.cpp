...
void t_rocket_moving_system::move_rocket_for(t_component_rocket& rocket, const t_spaceship_component& aim_spaceship, const t_delta delta) {
    ...
    const t_speed_entity rocket_delta_speed = rocket.get_speed() * delta;
