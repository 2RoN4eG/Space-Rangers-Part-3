...
t_spaceship_component::t_spaceship_component(const t_spaceship_id_entity id, const t_is_player is_player)
    : _id { id }
...
t_is_player t_spaceship_component::is_player() const { return _is_player; }
