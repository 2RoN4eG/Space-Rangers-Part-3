...
t_2d_position& t_component_planet::position() {
    return _cached_position;
}

t_2d_position t_component_planet::get_position() const {
    return _cached_position;
}

void t_component_planet::set_position(t_2d_position position) {
